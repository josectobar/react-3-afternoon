...
export default class Post extends Component {
  ...
  render() {
    ...
    const { id, text, updatePostFn, deletePostFn } = this.props
    ...
    return (
      ...
      <section className="Post__parent" onClick={ this.hideMasterMenu }>
        ...
        <div className="Post__meta-data">
          ...
          <span className="Post__date">{text}</span>
        </div>
        ...
        <div className="Post__content">
          {
            ...
            editing
            ?
              <Edit text={text} id={id} updatePostFn={updatePostFn} hideEdit={ this.hideEdit } />
            :
